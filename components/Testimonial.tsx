function StarIcon() {
  return (
    <svg className="h-5 w-5 text-copper-400" fill="currentColor" viewBox="0 0 20 20">
    ...
    <section id="testimonial" className="bg-[#0d0d10]">
      <div className="mx-auto max-w-6xl px-6 py-20 md:py-24">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="col-span-full lg:col-span-2 bg-[#111113] border border-[rgba(212,168,83,0.12)] rounded-2xl p-8 transition-all duration-200 hover:-translate-y-1 hover:border-[rgba(212,168,83,0.25)]">
            ...
            <blockquote className="font-sans text-lg text-zinc-300 italic leading-relaxed">
              &quot;Boards arrived two days ahead of schedule. Impedance was spot-on, silkscreen
              clean, no lifted pads — our QA passed them first attempt. What I appreciated most was
              having someone in the US I could actually call when we hit a stackup question
              mid-build. That&apos;s rare.&quot;
            </blockquote>
          ...
          <div className="bg-gradient-to-b from-[#1a1408] to-[#111113] border border-copper-800/30 rounded-2xl p-8 flex flex-col justify-between">
            <div>
              ...
              <div className="mt-2 font-sans text-sm text-zinc-400">
                Across 10+ major markets — from prototype to sustained production programs.
              </div>
            </div>
            <a
              href="#contact"
